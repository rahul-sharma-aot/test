...
function showloader2(nav) {
	...
	$(".loader-holder").css("display","block");
       ...
       setTimeout(function(){ $(".loader-holder").removeClass("no-vis-load")}, 500);
		setTimeout(function(){ window.location = nav+".html"}, 1000);
...
function preventDefault(e) {
 ...
 $(document).on('touchmove', function(e) {
	...
	$(document).on('mousemove', function(event) {
	 mouseX = window.clientWidth - (event ?  event.clientX : window.clientWidth / 2) ;
		 mouseY = window.clientHeight - (event ?  event.clientY : window.clientHeight / 2) ;
		setPolygon()
		console.log(mouseX,mouseY);
	});
...
var mask2 = $('.mask2')
  ...
  var tl2 = new TimelineMax( )
	 	 ...
	 	 tl.to(mask1, .2, {width:((100-mousePercentX)) + "%",  ease:Power0.easeOut})
	tl2.to(mask2, .2, {width:((mousePercentX)) + "%",  ease:Power0.easeOut})
...
var last = keys[keys.length-1]
    ...
    $(".titleanim.active").text(Object.values(worksprop)[0].name);
	 $(".bgactive .bgfix").css("background-image","url("+Object.values(worksprop)[0].backgroundimagerul+")");
	 
	  $(".bgafter .bgfix").css("background-image","url("+Object.values(worksprop)[1].backgroundimagerul+")");
...
anime({
 ...
 var htmldetail='';
		 ...
		 $( "#content").unbind('touchstart touchmove scroll mousedown wheel DOMMouseScroll mousewheel') 
		...
		if(Object.values(Object.values(worksprop)[page-1].category).length>1){
		 ...
		 if(worksprop[key].mobile!=null){
			 ...
			 var j;
		 for (j = 0; j <  Object.values(Object.values(worksprop)[page-1].mobile).length; j++) { 
			 
			
			 arrmock.push( Object.values(Object.values(worksprop)[page-1].mobile)[j].link);
		 ...
		 var i;
		 for (i = 0; i <  Object.values(Object.values(worksprop)[page-1].detail).length; i++) { 
			
			links=Object.values(Object.values(Object.values(worksprop)[page-1].detail)[i].link);
			 
			 titles=Object.values(Object.values(Object.values(worksprop)[page-1].detail)[i].title);
			 if(coklu){
				 
				 if(Object.values(Object.values(worksprop)[page-1].detail)[i].type=="mobile"){
					 
					  arrmobile.push( Object.values(Object.values(Object.values(worksprop)[page-1].detail)[i].link));
						
									 
					 }
				 if(Object.values(Object.values(worksprop)[page-1].detail)[i].type=="web"){
			  if(i==0){
				  
					  htmldetail+='<div class="workspart "><div class="container"><h3 class="titleee">'+titles+'</h3><svg class="animtext"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle">'+titles+'</text></svg><div class="imgholder trans"><img src="'+links+'"></div></div></div>';
			...
			if(i & 1)
{
   ...
   htmldetail+='<div class="workspart cift right"><div class="container"><h3 class="titleee">'+titles+'</h3><svg class="animtext"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle">'+titles+'</text></svg><div class="imgholder trans"><img src="'+links+'"></div></div></div>'
	
}
else
{
  htmldetail+='<div class="workspart cift left"><div class="container"><h3 class="titleee">'+titles+'</h3><svg class="animtext"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle">'+titles+'</text></svg><div class="imgholder trans"><img src="'+links+'"></div></div></div>'
...
else
{
  htmldetail+='<div class="workspart cift left"><div class="container"><h3 class="titleee">'+titles+'</h3><svg class="animtext"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle">'+titles+'</text></svg><div class="imgholder trans"><img src="'+links+'"></div></div></div>'
		 ...
		 if(worksprop[key].mobile!=null){
		htmldetail+='<div class="workspart nopad"><img src="'+arrmock[0]+'"></div>'
		 ...
		 htmldetail+='<div class="workspart mobile"><div class="container"><h3 class="titleee">MOBILE</h3><svg class="animtext"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle">MOBILE</text></svg><div class="centerence">';
			var m;
			for (m = 0; m <  arrmobile.length; m++) { 
			
			  htmldetail+='<div class="imgholder trans"><img src="'+arrmobile[m]+'"></div>';
		...
		htmldetail+='</div></div></div></div>';
		  ...
		  htmldetail+='<div class="workspart fonts" style="background-color:'+Object.values(Object.values(worksprop))[page-1].color+'"><div class="container"><h3 class="titleee">FONTS</h3><svg class="animtext"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle">FONTS</text></svg><div class="imgholder trans"><img src="'+fontpath+'"></div></div></div>';
		
		 
		 htmldetail+='<div class="workspart"><div class="container"><h3 class="titleee">COLOR CONCEPT</h3><svg class="animtext"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle">COLOR CONCEPT</text></svg><div class="imgholder trans"><ul class="colorlist">';
			
			
		 
		 
		 var k;
		 for (k = 0; k <  Object.values(Object.values(worksprop)[page-1].colorconsept).length; k++) { 
			
			colorconcepts=Object.values(Object.values(worksprop)[page-1].colorconsept)[k];
			 htmldetail+='<li><span class="box" style="background-color:'+colorconcepts+'"></span><span class="colorhex" style="color:'+colorconcepts+'">'+colorconcepts+'</span></li>'
		...
		htmldetail+='<div class="workspart nopad iconic"><div class="container"><h3 class="titleee">ICON</h3><svg class="animtext"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle">ICON</text></svg><div class="imgholder trans"><img src="'+icon[0]+'"></div></div></div>'
	...
	$(".section.two .full-page").scroll(function(){$( ".animtext" ).each(function( index ) {
		var textoo=$(this);
 ...
 $( ".leftinfo" ).css("position","absolute")
		anime({
		  ...
		  setTimeout(function(){$( ".imageslider" ).css("position","static");
...
$('.section.two .fullpager').animate({
		 ...
		 $("#content").on('scroll mousedown wheel DOMMouseScroll mousewheel', function(event) {	
...
if(downside>=1){	
   ...
   $(this).css("transform", "translateX("+distance+"px)");
	...
	var k;
			...
			circlehtml+='<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"   viewBox="-50 -180 1255 1000" id="svganim" preserveAspectRatio="xMidYMid meet" style="overflow:visible">';		
						
for (k = 0; k < 500; k++) { 
	
		
	circlehtml+='<circle class="circlees" cx="'+bulut[k].cx+'" cy="'+bulut[k].cy+'" r="4"/>';
...
var svg = $("#svganim");
function animateDiv(myclass, ccx, ccy, vievboxesx, vievboxesy, viewBoxeswidth, viewBoxesheight ){
 ...
 TweenMax.to(svg, 1, {attr:{viewBox: viewBoxesxx + " " + viewBoxesyy + " " + viewBoxeswidthh + " " + viewBoxesheightt}
    });
...
$("body").removeClass("mobilemid");
	...
	$("body").toggleClass("mobilemid");
					...
					$('<img/>').attr('src', Object.values(worksprop)[page-1].backgroundimagerul).on('load', function() {
   $(this).remove(); // prevent memory leaks as @benweet suggested
				 ...
				 $(".mask"+(page-1)+"bg").after("<div class=\"mask" + (page) + "bg\"><div class='bgafter bgstats'><div class='bgfix'></div></div></div>");
				 $( ".bgfix" ).each(function( index ) {
			...
			$(this).height(window.clientHeight);
					...
					$(".bgafter .bgfix").css("background-image","url("+Object.values(worksprop)[page-1].backgroundimagerul+")");
					
						
						
					 TweenMax.to(".titleanim",  0.5, {y: 100+"%",ease:Quart.easeInOut, onComplete: changetext})
						TweenMax.to(".workspecs li span",  0.5, {y: 100+"%",ease:Quart.easeInOut})
						
						
					   TweenMax.to(".titlesmall",  0.5, {y: 100+"%",ease:Quart.easeInOut})
					TweenMax.set(".bgactive", {bottom:"auto",top:"0"});
					
					TweenMax.set(".bgfix", {bottom:"auto",top:"0"});
					 TweenMax.to(".bgactive",  0.7, {height: 0+"%",ease:Quart.easeInOut})
					 
					TweenMax.to(".bgactive .bgfix", 1, {opacity:"0",y:"-90%",ease:Quart.easeInOut});
					/*TweenMax.to(".rectmask",  1, {fill:Object.values(worksprop)[page-1].color,ease:Quart.easeInOut})*/
					 ...
					 function changetext() {
						...
						$(".mask"+(page)+"bg").after("<div class=\"mask" + (page+1) + "bg\"><div class='bgafter bgstats'><div class='bgfix'></div></div>");
						 ...
						 TweenMax.fromTo(".workspecs li span", 0.5, {y: -100+"%"}, {y: 0+"%",ease:Quart.easeInOut} )
						TweenMax.fromTo(".titleanim", 0.5, {y: -100+"%"}, {y: 0+"%",ease:Quart.easeInOut} )
							TweenMax.fromTo(".titlesmall", 0.5, {y: -100+"%"}, {y: 0+"%",ease:Quart.easeInOut} )
			...
			$(this).height(window.clientHeight);
					...
					TweenMax.to(".bgactive .bgfix", 1, {opacity:"0",y:"90%",ease:Quart.easeInOut});
					 ...
					 $(".bgactive").parent().remove();
						 ...
						 $(".mask"+(page)+"bg").after("<div class=\"mask" + (page-1) + "bg\"><div class='bgafter bgstats'><div class='bgfix'></div></div></div>");
...
if(downside>=1){	
	...
	if(page==1){
		...
		animateDiv($(".circlees")[k], bulut[k].cx, bulut[k].cy, -50, -180, 1255, 1000);
		
	}
	else if(page==2){
		
		animateDiv($(".circlees")[k], sepet[k].cx, sepet[k].cy, -100, -80, 1255, 1100);
		
	}
	else if(page==3){
		
		animateDiv($(".circlees")[k], ufo[k].cx, ufo[k].cy, 0, -80, 1255, 1000);
		
	}
	else if(page==4){
		
		animateDiv($(".circlees")[k], kosu[k].cx, kosu[k].cy, 0, -80, 955, 1200);
		
	}
	else if(page==5){
		
		animateDiv($(".circlees")[k], ucak[k].cx, ucak[k].cy, 0, -280, 1655, 1100);
		
	}
	else if(page==6){
		
		
		animateDiv($(".circlees")[k], elma[k].cx, elma[k].cy, 0, -50, 1055, 1200);
	}
...
for (i = 0; i < Object.keys(skills).length; i++) { 
	 ...
	 if(obj==skillhoveritem){
		...
		$(".specs2 .years h1 span").text(Object.values(skills)[i].year)
		 ...
		 TweenMax.to($(".specs2"), 0.5, {opacity:1, onComplete:skillanim})
...
var tl3 = new TimelineLite();
		 ...
		 tl3.to(".text1", 0.5, {strokeDashoffset:"0", fillOpacity:"1",onComplete:percenter})
		 TweenMax.to(".pt-line", 1, {strokeDashoffset:"0"})
		 tl4.to(".skillsamount2",  0.5, {opacity:"1"})
		 tl3.to(".years2",  0.5, {opacity:"1"})
		 
		 function percenter(){
		TweenMax.fromTo(".percent2", 1, {css: {left: "50px"}}, {css:{left:numknow+"%"}} )
		TweenMax.fromTo(".fillbar2", 1, {css: {width: "0"}}, {css:{width:numknow+"%"}} )
		var counter = {score:0}
		numknowstr=Number(numknow)
		
		TweenMax.to(counter, 1, {score:numknowstr, roundProps:"score", onUpdate:updateHandler, ease:Linear.easeNone});

		
function updateHandler() {console.log(counter.score)
...
break;
	...
	$(".specs1 .fillbar").css("background-color",Object.values(skills)[i].color)
	$(".specs1 .percent").css("color",Object.values(skills)[i].color)
		 
	
		 
		 TweenMax.to($(".specs1"), 0.5, {opacity:1, onComplete:skillanim})
...
var tl3 = new TimelineLite();
		 ...
		 function percenter(){
		TweenMax.fromTo(".percent", 1, {css: {left: "50px"}}, {css:{left:numknow+"%"}} )
		TweenMax.fromTo(".fillbar", 1, {css: {width: "0"}}, {css:{width:numknow+"%"}} )
		var counter = {score:0}
		numknowstr=Number(numknow)
...
$( this ).mouseleave(function() {
	 ...
	 $(".num").text(0);
	   if($("body").hasClass("science")){
	 TweenMax.to($(".specs2"), 0.5, {opacity:0,  onComplete:skillanimreverse});
	 
	 }
	 if($("body").hasClass("art")){
	 TweenMax.to($(".specs1"), 0.5, { opacity:0, onComplete:skillanimreverse});
	...
	$('.input').blur(function(){
		...
		$('.form-right').click(function(e){	
			    if( $('#name').val() && $('#mail').val() && $('#text').val() ) {
				    ...
				    $('.mesajlightbox').prepend("<span class='alert'>Lütfen Tüm alanları doldurun!</span>");
...
function animtitle() {
	...
	$(".cbp-popup-wrap").scroll(function(){$( ".animtext" ).each(function( index ) {
		var textoo=$(this);
		var distance=$(this).offset().top-$(window).height()/2;
